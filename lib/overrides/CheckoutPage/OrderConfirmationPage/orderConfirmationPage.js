...
import defaultOrderConfirmationPageClasses from '@magento/venia-ui/lib/components/CheckoutPage/OrderConfirmationPage/orderConfirmationPage.module.css';
import defaultClasses from './orderConfirmationPage.module.css';
import PaymentInformationPixQrCode from '@devgfnl/pwastudio-magento2-pixqrcode/lib/components/PaymentInformationPixQrCode';

const OrderConfirmationPage = props => {
    const classes = useStyle(
        defaultClasses,
        defaultOrderConfirmationPageClasses,
        props.classes
    );
    ...
    return (
        <div className={classes.root} data-cy="OrderConfirmationPage-root">
            ...
            <div className={classes.mainContainer}>
                ...
                <PaymentInformationPixQrCode orderNumber={orderNumber} />
