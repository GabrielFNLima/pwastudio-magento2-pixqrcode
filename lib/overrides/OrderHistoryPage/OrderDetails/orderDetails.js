...
import PaymentInformationPixQrCode from '../../../components/PaymentInformationPixQrCode/paymentInformationPixQrCode';
    ...
    return (
        <div className={classes.root}>
            ...
            <div className={classes.paymentMethodContainer}>
                ...
                >
                    {payment_methods[0].type === 'gfnl_pixqrcode' ? (
                        <PaymentInformationPixQrCode
